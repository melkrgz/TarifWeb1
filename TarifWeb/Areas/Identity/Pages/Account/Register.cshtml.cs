...
namespace TarifWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManager.Roles.Where(i => i.Name == Diger.Rol_Admin)
                .Select(x => x.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user.Rol == null)
                    {
                        await _userManager.AddToRoleAsync(user,Diger.Rol_Kullanici);
                    }
                    else
                    {
